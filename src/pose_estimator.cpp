...
cv::RotatedRect redBoundBox;
cv::RotatedRect greenBoundBox;
cv::RotatedRect blueBoundBox;
...
void image_callback(const sensor_msgs::ImageConstPtr& msg){
  ...
  cv::rectangle(cv_ptr->image, redBoundBox.boundingRect(), cv::Scalar( 0, 255, 0 ), 2, 1 );
